        ...
        <div class="overflow-x-auto">
          <table class="table table-sm">
            ...
            <tbody>
              ...
              <tr><td class="font-semibold text-sm">ADX + DI</td><td class="font-mono text-xs">adx_di</td><td class="text-xs">Trade +DI/−DI crosses only when ADX shows a trend; ATR stops</td><td class="text-xs font-mono">1h, ADX 14 ≥ 25, SL 2 ATR, TP 3 ATR</td></tr>
              <tr><td class="font-semibold text-sm">Keltner Channel</td><td class="font-mono text-xs">keltner</td><td class="text-xs">EMA ± ATR envelope; breakout or fade the band</td><td class="text-xs font-mono">1h, EMA 20 ± 1.5 ATR(10), SL 2 ATR</td></tr>
      ...
      <div class="px-5 pb-5 pt-3 border-t border-base-300 overflow-x-auto">
        ...
        <table class="table table-sm">
          ...
          <tbody>
            ...
            <tr><td class="font-mono text-xs">adx_di</td><td class="text-xs">ADX is trend strength (no direction). +DI/−DI cross sets long/short. Ignored when ADX is below the min. Also exits on an opposite DI cross. Stops are ATR multiples.</td></tr>
            <tr><td class="font-mono text-xs">keltner</td><td class="text-xs">ATR envelope around an EMA (Bollinger’s ATR twin). Breakout: close outside the band, exit at ATR stop/TP or back through the EMA. Mean reversion: fade the band, target the EMA.</td></tr>
